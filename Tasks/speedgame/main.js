...
const loadmusic = new Audio('assets/opened.wav'); // Create aclass to store data locally
...
const startgame = () => {
  ...
  endButton.style.display = 'block'; // Enable clicking of the div, clicking was disabled in css at initial
...
const EndGame = () => {
  ...
  pace = 2000; //   Disable the clicking of the divs circles till game start is clicked
...
closemodalbtn.addEventListener('click', closemodalbtnF); // add even to all circle div through a loop, then we pass the element and index position to a function
